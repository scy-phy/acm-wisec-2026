...
The overall conference schedule is available below. For further details, refer to the detailed [conference](/program-detailed-program/) and [workshop](/workshop-wiseml-program/) programs.
...
<tr class="row_9">
	...
	<td rowspan="2" class="session">
		<span title="session-2">Session 2: Security Analysis of Modern Computing Architectures</span>
	</td>
	<td rowspan="3" class="session">
...
<tr class="row_105">
	<td class="tt_hours_column">14:15</td>
	<td class="break" rowspan=2>
	  <span title="Coffee">Break</span>
	  </td>
</tr>
